    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Tastatura tastatura=new Tastatura(Integer.parseInt(etnMSN.getText().toString()),spin.toString(),etManufacturer.toString(),wireless);

                Intent intent=new Intent();
                intent.putExtra("valoare",tastatura);
